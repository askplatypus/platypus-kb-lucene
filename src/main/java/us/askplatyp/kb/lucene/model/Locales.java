...
public final class Locales {
    ...
    public static final Locale LATIN_AMERICA_SPANISH = Locale.forLanguageTag("es_419");
    ...
    public static final Locale FILIPINO = Locale.forLanguageTag("fil");
    ...
    public static final Locale LATIN = Locale.forLanguageTag("la");
    ...
    public static final Locale SWAHILI = Locale.forLanguageTag("sw");
    ...
    public static final Locale SIMPLIFIED_CHINESE = Locale.forLanguageTag("zh-Hans");
    public static final Locale TRADITIONAL_CHINESE = Locale.forLanguageTag("zh-Hant");
}
